...
namespace prs_serever_mvc.Controllers
{
    public class RequestLinesController : Controller
    {
        private readonly CornerstonePRSPracticeContext _context;

        public RequestLinesController(CornerstonePRSPracticeContext context)
        {
            _context = context;
        }
        ...
        {
            var cornerstonePRSPracticeContext = _context.RequestLines.Include(r => r.Product).Include(r => r.Request);
            return View(await cornerstonePRSPracticeContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,RequestId,ProductId,Qty")] RequestLine requestLine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RequestId,ProductId,Qty")] RequestLine requestLine)
        {
