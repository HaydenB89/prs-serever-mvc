...
{
    public partial class CornerstonePRSPracticeContext : DbContext
    {
        public CornerstonePRSPracticeContext()
        {
        }

        public CornerstonePRSPracticeContext(DbContextOptions<CornerstonePRSPracticeContext> options)
            : base(options)
        {
        }
